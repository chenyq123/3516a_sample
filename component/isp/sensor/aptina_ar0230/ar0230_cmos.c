...
static AWB_CCM_S g_stAwbCcm =
{
    4900,
    {
        0x01F6, 0x80BE, 0x8038,
        0x804A, 0x016C, 0x8022,
        0x0009, 0x80AB, 0x01A2
    },
        
    3810,
    {
        0x01DA, 0x8092, 0x8048,
        0x8069, 0x017D, 0x8014,
        0x8008, 0x80C5, 0x01CD
    },

    2650,
    {
        0x0208, 0x80B9, 0x804F,
        0x8064, 0x016C, 0x8008,
        0x800C, 0x81B2, 0x02BE
    }
};
...
static HI_S32 cmos_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->as32WbPara[0] = 0x004A;
    pstAwbSnsDft->as32WbPara[1] = 0x000B;
    pstAwbSnsDft->as32WbPara[2] = -0x00AC;
    pstAwbSnsDft->as32WbPara[3] = 0x16C2A;
    pstAwbSnsDft->as32WbPara[4] = 0x0080;
    pstAwbSnsDft->as32WbPara[5] = -0x0D469;
