...
void sensor_linear_720p_120fps_init();
...
void sensor_init()
{
    ...
    switch (gu8SensorImageMode)
    {
        ...
        case 5: // 720 120
            ...
            {
                sensor_linear_720p_120fps_init();
            }
            else
            {
...
void sensor_enable_wdr_mode()
{
    ...
    sensor_write_register(0x301a, 0xf9);

    sensor_write_register(0x301a, 0xf1);
    sensor_write_register(0x4805, 0x00);
    sensor_write_register(0x301a, 0xf0);
}
void sensor_init_comm_first()
{
...
void sensor_init_comm_second()
{
    ...
    sensor_write_register(0x402a, 0x06);
    sensor_write_register(0x402b, 0x04);
    ...
    sensor_write_register(0x4837, 0x56);
    ...
    sensor_write_register(0x3105, 0x31);
    sensor_write_register(0x301a, 0xf9);
    sensor_write_register(0x3508, 0x07);
    sensor_write_register(0x484b, 0x05);
    sensor_write_register(0x4805, 0x03);
    sensor_write_register(0x3601, 0x01);
    //sensor_write_register(0x0100, 0x01);
    delay_ms(10);
    sensor_write_register(0x3105, 0x11);
    //sensor_write_register(0x301a, 0xf1);
    sensor_write_register(0x4805, 0x00);
    //sensor_write_register(0x301a, 0xf0);
    ...
    sensor_write_register(0x302a, 0x00);
    sensor_write_register(0x302a, 0x00);
    sensor_write_register(0x3601, 0x00);
    sensor_write_register(0x3638, 0x00);
...
void sensor_init_4M50()
{
    ...
    //sensor_write_register(0x030f, 0x03);
    ...
    sensor_write_register(0x380d, 0xc0);
     //sensor_write_register(0x380c, 0x07);
    //sensor_write_register(0x380d, 0x30);

    sensor_write_register(0x380e, 0x06);
    sensor_write_register(0x380f, 0x60);
...
void sensor_init_4M30()
{
    ...
    sensor_write_register(0x0301,0x00);
    sensor_write_register(0x0302,0xf4);    
    sensor_write_register(0x0303,0x03);
    sensor_write_register(0x0304,0x03);    
    sensor_write_register(0x030A,0x01);    
    sensor_write_register(0x030b,0x00);    
    sensor_write_register(0x030d,0x1e);    
    sensor_write_register(0x030e,0x04);    
    sensor_write_register(0x030f,0x01);
    ...
    sensor_write_register(0x380a,0x05);
    sensor_write_register(0x380b,0xf0);    
    sensor_write_register(0x380c,0x09);    
    sensor_write_register(0x380d,0x94);    
    sensor_write_register(0x380e,0x06);    
    sensor_write_register(0x380f,0x60);    
    sensor_write_register(0x3810,0x00);    
    sensor_write_register(0x3811,0x08);    
...
void sensor_linear_1080p60_init()
{
    ...
    sensor_write_register(0x3002, 0x00);    
    sensor_write_register(0x3018, 0x72);    
    sensor_init_comm_first();    
    sensor_write_register(0x3800, 0x01);    
    sensor_write_register(0x3801, 0x88);    
    sensor_write_register(0x3802, 0x00);    
    ...
    sensor_write_register(0x380c, 0x06);    
    sensor_write_register(0x380d, 0xF4);    
    sensor_write_register(0x380e, 0x04);    
    sensor_write_register(0x380f, 0x63);    
    //sensor_init_comm_second();
    sensor_write_register(0x3810, 0x00);
    sensor_write_register(0x3811, 0x08);
    sensor_write_register(0x3812, 0x00);
    sensor_write_register(0x3813, 0x04);
    ...
    sensor_write_register(0x4502, 0x40);
    sensor_write_register(0x4503, 0x01);
    sensor_write_register(0x4601, 0x77);
    sensor_write_register(0x4800, 0x04);
    sensor_write_register(0x4813, 0x08);
    sensor_write_register(0x481f, 0x40);
    sensor_write_register(0x4829, 0x78);
...
void sensor_wdr_1080p30_init()
{
    ...
    sensor_write_register(0x380f, 0x20);
    //sensor_init_comm_second();
    sensor_write_register(0x3810, 0x00);
    sensor_write_register(0x3811, 0x08);
    sensor_write_register(0x3812, 0x00);
...
void sensor_linear_1080p30_init()
{
    ...
    sensor_write_register(0x0300, 0x02);   
    sensor_write_register(0x0301, 0x00);
    sensor_write_register(0x0302, 0x7C);   
    sensor_write_register(0x0303, 0x03);
    sensor_write_register(0x0304, 0x03);   
    sensor_write_register(0x030A, 0x01);   
    sensor_write_register(0x030b, 0x00);   
...
void sensor_wdr_2048_1520_30_init()
{
    ...
    sensor_write_register(0x380c,0x05);
    sensor_write_register(0x380d,0x28);
    sensor_write_register(0x380e,0x05);
    sensor_write_register(0x380f,0x80);
    printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    sensor_write_register(0x3810,0x00);
    sensor_write_register(0x3811,0x08);
    sensor_write_register(0x3812,0x00);
...
{   
    ...
    sensor_write_register(0x380a, 0x05);    
    sensor_write_register(0x380b, 0x10);    
    sensor_write_register(0x380c, 0x08);    
    sensor_write_register(0x380d, 0x74);    
    sensor_write_register(0x380e, 0x05);    
    sensor_write_register(0x380f, 0x77);    
    //sensor_init_comm_second();
    sensor_write_register(0x3810, 0x00);
    sensor_write_register(0x3811, 0x08);
    sensor_write_register(0x3812, 0x00);
...
{   
    ...
    sensor_write_register(0x380c, 0x07);
    sensor_write_register(0x380d, 0x74);
    sensor_write_register(0x380e, 0x08);
...
void sensor_linear_720p_120fps_init()
{
    ...
    sensor_write_register(0x030d,0x1e); 
    sensor_write_register(0x030e,0x04); 
    sensor_write_register(0x030f,0x02); 
    sensor_write_register(0x0312,0x01); 
    sensor_write_register(0x031e,0x00); 
    sensor_write_register(0x3000,0x20); 
    sensor_write_register(0x3002,0x00); 
    ...
    sensor_write_register(0x380d,0x5C); 
    ...
    sensor_write_register(0x4503,0x01); 
    sensor_write_register(0x4601,0x4F); 
    sensor_write_register(0x4800,0x04); 
    sensor_write_register(0x4813,0x08); 
    sensor_write_register(0x481f,0x40); 
    sensor_write_register(0x4829,0x78); 
