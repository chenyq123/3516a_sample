...
HI_S32 SAMPLE_RGN_AddCoverExToVpss(HI_VOID)
{
    ...
    stRgnAttrInfo.Handle    = Handle;
    stRgnAttrInfo.u32RgnNum = u32RgnNum;
    pthread_create(&stRgnThread, NULL, SAMPLE_RGN_VpssCoverExDynamicDisplay, (HI_VOID*)&stRgnAttrInfo);
...
HI_S32 SAMPLE_RGN_AddOsdToVencAndVpss(HI_VOID)
{
    ...
    pthread_t stVencRgnThread;
    pthread_t stVpssRgnThread;
    VENC_PTHREAD_INFO_S stVencGetPram;
    pthread_t stVpssOsdReverseThread;
    pthread_t stVencOsdReverseThread;
    ...
    /*************************************************
      ...
      layer, position, alpha and other display attribute
     *************************************************/
    pthread_create(&stVencRgnThread, NULL, SAMPLE_RGN_VencOSdDynamicDisplay, NULL);
    stRgnAttrInfo.Handle    = VpssOsdHandle;
    stRgnAttrInfo.u32RgnNum = u32VpssRgnNum;
    pthread_create(&stVpssRgnThread, NULL, SAMPLE_RGN_VpssOSdDynamicDisplay, (HI_VOID*)&stRgnAttrInfo);
    sleep(3);
    /*************************************************
    ...
    pthread_create(&stVpssOsdReverseThread, NULL, SAMPLE_RGN_VpssOsdReverse, (HI_VOID*)&stVpssOsdReverseInfo);
    ...
    pthread_create(&stVencOsdReverseThread, NULL, SAMPLE_RGN_VencOsdReverse, (HI_VOID*)&stVencOsdReverseInfo);
    ...
    pthread_join(stVpssRgnThread, 0);
    pthread_join(stVencRgnThread, 0);
    pthread_join(stVpssOsdReverseThread, 0);
    pthread_join(stVencOsdReverseThread, 0);
