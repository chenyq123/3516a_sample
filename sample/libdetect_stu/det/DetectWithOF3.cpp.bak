	...
	: Detect(cfg)
{
	...
	d_gray_prev_ = cv::Mat(video_height_, video_width_, CV_8UC1);
...
void DetectWithOF3::calc_optical_flow(const cv::Mat &p0, const cv::Mat &p1, cv::Mat &dis, cv::Mat &ang, cv::Mat &dx, cv::Mat &dy)
{
	...
	of_.polySigma = fb_polysigma_;
    */
    calcOpticalFlowFarneback(d_gray_prev_, d_gray_curr_, flow,
	...
	cv::cartToPolar(d_dx_, d_dy_, d_distance_, d_angle_, true);
